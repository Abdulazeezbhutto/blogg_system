            ...
            <div class="row align-items-center mb-5">
                <div class="col-lg-6" data-aos="fade-right" data-aos-duration="1000">
                    ...
                    <p class="lead text-muted">
                        Welcome to our blogging platform! We are passionate about sharing ideas,
                        stories, and knowledge with the world. Our goal is to create a community
                        where everyone can express themselves and learn from each other.
                    </p>
                </div>
                <div class="col-lg-5 text-center" data-aos="fade-left" data-aos-duration="1000">
                    <img src="{{ asset('uploads/image/about.png') }}"
                         class="img-fluid rounded-6 shadow"
                         alt="About Us">
                </div>
            </div>
            ...
            <div class="row text-center mb-5">
                ...
                <div class="col-md-6 mb-4" data-aos="zoom-in" data-aos-delay="400">
                    <div class="card shadow-sm border-0 h-100 p-4">
                        ...
                        <p class="text-muted">
                            To become one of the best blogging communities that empowers voices
                            from all walks of life and makes knowledge accessible to everyone.
                        </p>
                    </div>
                </div>
            </div>
                ...
                @foreach ($admins as $admin)
                    <div class="col-md-4 mb-4" data-aos="fade-up" data-aos-delay="200">
                        <div class="card shadow border-0 text-center p-4">
                            <img src="{{ asset('uploads/profile/' . $admin->image_path) }}"
